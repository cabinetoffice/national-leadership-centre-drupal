...
use Drupal\neo4j_db_entity\EventSubscriber\AbstractNodeUpdateSubscriber;
use Drupal\neo4j_db_entity\EventSubscriber\AbstractUserUpdateSubscriber;

class ProgrammeYearUpdateSubscriber extends AbstractNodeUpdateSubscriber {
  ...
  protected function subscriberModelService() {
    return 'network_individual.model.programme_year';
  }
