...
abstract class AbstractUserInsertSubscriber extends AbstractEntityEventInsertSubscriber {
   ...
   */
  protected function insertGraphUserNode(): void {
    $this->accountModel = \Drupal::service($this->subscriberModelService());
    $this->accountModel->setEntity($this->account);
//    $this->accountModel->setEntityId($this->account->id());
    $this->accountModel->setName($this->account->label());
    $this->setAccountModelExtraFieldValues();
    $this->accountModel->modelPersist();
  }
